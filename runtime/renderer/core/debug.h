...
class DebugUtils {
 public:
  ...
  virtual void set_debug_name(VkDevice device, VkObjectType object_type,
                              uint64_t object_handle,
                              const char *name) const = 0;

  /// @brief Tags the given Vulkan object with some data.
  virtual void set_debug_tag(VkDevice device, VkObjectType object_type,
  ...
  virtual void cmd_begin_label(VkCommandBuffer command_buffer, const char *name,
                               glm::vec4 color = {}) const = 0;
...
class DebugUtilsExtDebugUtils final : public DebugUtils {
 public:
  ...
  void set_debug_tag(VkDevice device, VkObjectType object_type,
                     uint64_t object_handle, uint64_t tag_name,
                     const void *tag_data, size_t tag_data_size) const override;

  void cmd_begin_label(VkCommandBuffer command_buffer, const char *name,
                       glm::vec4 color) const override;

  void cmd_end_label(VkCommandBuffer command_buffer) const override;

  void cmd_insert_label(VkCommandBuffer command_buffer, const char *name,
                        glm::vec4 color) const override;
};
...
class DummyDebugUtils final : public DebugUtils {
 public:
  ...
  inline void set_debug_name(VkDevice, VkObjectType, uint64_t,
                             const char *) const override {}

  inline void set_debug_tag(VkDevice, VkObjectType, uint64_t, uint64_t,
                            const void *, size_t) const override {}

  inline void cmd_begin_label(VkCommandBuffer, const char *,
                              glm::vec4) const override {}

  inline void cmd_end_label(VkCommandBuffer) const override {}

  inline void cmd_insert_label(VkCommandBuffer, const char *,
                               glm::vec4) const override {}
};
...
class ScopedDebugLabel final {
 public:
  ScopedDebugLabel(const DebugUtils &debug_utils,
                   VkCommandBuffer command_buffer, const char *name,
                   glm::vec4 color = {});

  ScopedDebugLabel(const CommandBuffer &command_buffer, const char *name,
                   glm::vec4 color = {});
