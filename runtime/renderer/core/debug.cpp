...
void DebugUtilsExtDebugUtils::set_debug_tag(
    VkDevice device, VkObjectType object_type, uint64_t object_handle,
...
void DebugUtilsExtDebugUtils::cmd_end_label(
...
static const std::unordered_map<VkObjectType, VkDebugReportObjectTypeEXT>
    VK_OBJECT_TYPE_TO_DEBUG_REPORT_TYPE{
...
void DebugMarkerExtDebugUtils::cmd_end_label(
    VkCommandBuffer command_buffer) const {
