...
bool ResourceSet::is_dirty() const { return dirty; }

void ResourceSet::clear_dirty() { dirty = false; }

void ResourceSet::clear_dirty(uint32_t binding, uint32_t array_element) {
  resource_bindings[binding][array_element].dirty = false;
}

void ResourceSet::bind_buffer(const core::Buffer &buffer, VkDeviceSize offset,
...
void ResourceSet::bind_image(const core::ImageView &image_view,
...
void ResourceSet::bind_input(const core::ImageView &image_view,
...
bool ResourceBindingState::is_dirty() { return dirty; }

void ResourceBindingState::clear_dirty() { dirty = false; }

void ResourceBindingState::clear_dirty(uint32_t set) {
  resource_sets[set].clear_dirty();
}

void ResourceBindingState::bind_buffer(const core::Buffer &buffer,
...
void ResourceBindingState::bind_image(const core::ImageView &image_view,
...
void ResourceBindingState::bind_input(const core::ImageView &image_view,
                                      uint32_t set, uint32_t binding,
                                      uint32_t array_element) {
...
const std::unordered_map<uint32_t, ResourceSet> &
ResourceBindingState::get_resource_sets() {
