...
class ResourceRecord {
 public:
  ...
  size_t register_pipeline_layout(
      const std::vector<ShaderModule *> &shader_modules);

  size_t register_render_pass(
  ...
  void set_graphics_pipeline(size_t index,
 ...
 private:
  ...
  std::unordered_map<const GraphicsPipeline *, size_t>
      graphics_pipeline_to_index;
};
}  // namespace vkb